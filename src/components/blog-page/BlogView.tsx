      ...
      {userId === post?.author.id && (
        <div className="flex items-center justify-end gap-2">
          <Link
            ...
            className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-sm font-medium text-indigo-400 border border-indigo-400/20 hover:border-indigo-400/40 hover:bg-indigo-400/10 transition"
          >
            <LuPen />
            Edit
          </Link>
