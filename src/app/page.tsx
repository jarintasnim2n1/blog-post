...
export default function Home() {
  return (
    <ContainerLayout >
      <h1 className="text-3xl text-white/80 lg:text-5xl xl:text-7xl text-center tracking-wide leading-snug lg:leading-tight xl:leading-tight ">
        <span className="font-bold  text-orange-400/80">Welcome to TechBlog!</span> <br /> Discover
